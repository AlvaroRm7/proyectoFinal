        ...
        <li class="nav-item dropdown pe-3">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
            <li class="dropdown-header">
              <h6><?php echo $nombres ['nombres'];?></h6>
...
<!-- ======= Sidebar ======= -->
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
           ...
           <li>
            <a href="forms-registro_Docentes.php">
              <i class="bi bi-circle"></i><span>Registrar docentes</span>
            </a>
          </li>
        </ul>
      </li><!-- End Forms Nav -->
        ...
        <ul id="charts-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="charts-echarts.html">
              <i class="bi bi-circle"></i><span>Mostrar calificaciones calificaciones</span>
            </a>
          </li>
          <li>
            <a href="charts-echarts.html">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index_1.php">Inicio</a></li>
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <!-- Left side columns -->
<!-- End Left side columns AQUI IBA LO DE EN MEDIO E IRA EL LOGO COMO MENU-->
        <div class="col-lg-8">
            <div class="row">
            <img src="../assets/img/UNEDL_LOGO.jpg" alt="">
            </div>
        </div>

        <!-- Right side columns ESTA ES LA COLUMNA DE LA DERECHA-->
        <div class="col-lg-4">
